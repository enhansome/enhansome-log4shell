...
* [NCSC-NL repository](https://github.com/NCSC-NL/log4shell/tree/main/software) ⚠️ Archived - National Cyber Security Centrum list of vulnerable/non-vulnerable software.
* [CISA](https://github.com/cisagov/log4j-affected-db) ⚠️ Archived - CISA list of vulnerable software.
...
* [Community Sourced Log4J Attack Surface](https://github.com/YfryTchsGD/Log4jAttackSurface) ⭐ 2,072 | 🐛 44 | 📅 2021-12-13 - List of Log4j attack vectors in popular manufacturers' products.
...
* [Threatview IP list](https://github.com/Malwar3Ninja/Exploitation-of-Log4j2-CVE-2021-44228) ⭐ 15 | 🐛 0 | 📅 2021-12-19 - List of IP addresses currently exploiting log4shell.
* [LizardLabs query tool](https://github.com/lizardlabs/Log-Parser-Lizard-Queries/blob/master/queries/log4shell/log4shell.search.MD5.sql) ⭐ 7 | 🐛 0 | 📅 2021-12-11 - Search for vulnerable jar files using MS Log Parser.
* [AWS daemonset](https://github.com/aws-samples/kubernetes-log4j-cve-2021-44228-node-agent) ⚠️ Archived - Daemonset from AWS to mitigate vulnerable instances in Kubernetes.
...
* [Log4Shell PoC](https://github.com/snyk-labs/java-goof) ⭐ 105 | 🐛 235 | 🌐 Java | 📅 2026-08-05 - Full stack demo including Java LDAP and HTTP servers and vulnerable Java client. **NOTE**: It's part of the larger `java-goof` repo. Look at the `log4shell-goof` module.
